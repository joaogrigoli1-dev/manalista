...
// Página exportada envolve LoginForm em Suspense (obrigatório em Next.js 15
// quando useSearchParams é usado em um Client Component)
export default function LoginPage() {
  return (
    <main className="min-h-screen flex items-center justify-center bg-gray-950 px-4">
      <Suspense fallback={
        <div className="w-full max-w-md rounded-2xl border border-white/10 bg-white/5 p-8 text-center">
          <span className="h-6 w-6 border-2 border-white/30 border-t-white rounded-full animate-spin inline-block" />
        </div>
      }>
        <LoginForm />
      </Suspense>
